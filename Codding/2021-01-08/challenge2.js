...
// checking winning team from these three team
...
{
	console.log("John's and Mike's teams are winning");
}
else if (johnTeamAvg == merryTeamAvg && johnTeamAvg > mikeTeamAvg)
{
	console.log("John's and Merry's teams are winning");
}
else if (mikeTeamAvg == merryTeamAvg && mikeTeamAvg > johnTeamAvg)
{
	console.log("Mike's and Merry's teams are winning");
}
else
{
